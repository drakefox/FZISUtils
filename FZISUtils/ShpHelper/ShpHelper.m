...
NSMutableArray * shp2AGSGraphics(NSString * shpPath,NSString * shpName)
{
    ...
    for( i = 0; i < nEntities; i++ )
    {
        ...
        AGSGraphic * gra= nil;
        switch (nShapeType) {
            case SHPT_POINT: case SHPT_POINTZ:
            {
...
//                [line release];
                ...
                break;
            case SHPT_POLYGON: case SHPT_POLYGONZ:
            {
...
//                    NSString * fName  = [NSString stringWithUTF8String:szTitle];
                    NSString * fName  = [NSString stringWithCString:szTitle encoding:enc];
                ...
                case FTInteger:
                {
                    ...
                    //                    NSString * fName  = [NSString stringWithUTF8String:szTitle];
                    NSString * fName  = [NSString stringWithCString:szTitle encoding:enc];
                    [dict setObject:[NSNumber numberWithInt: DBFReadIntegerAttribute(hDBF, i, fIndex)] forKey:fName];
                }
                    break;
                ...
                case FTDouble:
                {
                    ...
                    //                    NSString * fName  = [NSString stringWithUTF8String:szTitle];
                    NSString * fName  = [NSString stringWithCString:szTitle encoding:enc];
                    [dict setObject:[NSNumber numberWithDouble: DBFReadDoubleAttribute(hDBF, i, fIndex)] forKey:fName];
                }
                    break;
